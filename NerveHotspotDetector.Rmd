...
In fact, with the objects we have created the spatial analysis pipelines published here https://bodenmillergroup.github.io/IMCDataAnalysis/performing-spatial-analysis.html are readily applicable and the results of this analysis can be associated with clinical info if available.

For now we will perform some extra visualisations of the nerve hotspots. 

```{r downstream analysis, echo=FALSE, eval=TRUE, error=TRUE, warning=FALSE,cache=TRUE}
library(sp)
